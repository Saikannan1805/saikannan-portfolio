...
const experiences: Exp[] = [
 {
  ...
  description: 
  `• Designed and deployed machine learning models for content feed personalization and moderation using NLP, deep learning, and recommendation systems.
  ...
  description: 
  `• Designed and implemented the Page Object Model (POM) architecture in Selenium, streamlining framework scalability and improving overall automation efficiency by 35%.
  ...
  description: 
  `• Developed a real-time hand gesture recognition system leveraging TensorFlow and OpenCV to detect and classify dynamic gestures from live camera streams.
  ...
  description: 
  `• Designed and developed *PILGRIM*, a cross-platform travel companion application using Flutter and Firebase, enabling seamless trip planning and social interaction among travelers.
